<x-layout title="Homepage Nintendo" />
<!--Header Homepage-->
<header class="container-fluid homepage d-flex justify-content-end">
    <div class="row">
        <div class="col-12 col-md-12 d-flex align-items-center">
            <h1 class="titolo">Homepage Nintendo</h1>
        </div>
    </div>
</header>
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active" data-bs-interval="5000">
                        ...
                        <div class="carousel-caption d-md-block">
                            ...
                            <p class="text-white fs-5">Dalle console più recenti fino a quelle più vecchie, più di 40 anni di successi</p>
                        </div>
                    </div>
                    ...
                    <div class="carousel-item" data-bs-interval="4000">
                        ...
                        <div class="carousel-caption d-md-block">
                            ...
                            <p class="fs-4 rounded transparent-blur">Sfoglia il catalogo degli altri giocatori per vedere cosa ti manca!</p>
                        </div>
                    </div>
                </div>
